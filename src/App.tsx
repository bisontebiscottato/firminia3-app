...
import { Bluetooth, Settings, ArrowRight, Signal, SignalLow } from 'lucide-react';
...
const MainApp: React.FC<{ 
  ...
  const [signalStrength, setSignalStrength] = React.useState<'strong' | 'weak'>('strong');
    ...
    <div className="min-h-screen bg-background text-foreground p-6">
      <div className="max-w-md mx-auto">
        <div className="text-center mb-8">
          ...
          <p className="text-muted-foreground">Connected device - Active session</p>
        </div>
          ...
          <div className="bg-card p-6 rounded-lg border border-border">
            ...
            <div className="flex items-center gap-3 p-3 bg-primary/5 rounded-lg mb-4">
              ...
              <div className="flex-1">
                ...
                <div className={`text-sm flex items-center gap-1 ${signalStrength === 'strong' ? 'text-success' : 'text-orange-500'}`}>
                  {signalStrength === 'strong' ? (
                    <Signal size={14} />
                  ) : (
                    <SignalLow size={14} />
                  )}
                  <span>{signalStrength === 'strong' ? 'Strong signal' : 'Weak signal'}</span>
                </div>
              </div>
